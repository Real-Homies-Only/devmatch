        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="mb-4">
            <input
              type="file"
              accept="image/*"
              className="file-input file-input-secondary file-input-bordered bg-background-700 text-gray-700 file-input-primary w-full"
          ...
          <div className="flex justify-end">
            ...
            <button
              type="submit"
              className="btn btn-primary bg-primary-700 border-none hover:bg-secondary-700"
            >
              Upload
            </button>
          </div>
